...
namespace LevverRH.Infra.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            // Tabelas já existem no banco - migration vazia para criar snapshot
        }

        // Código original comentado - tabelas já existem
        private void UpOriginal(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cor_primaria = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    rota_base = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ordem_exibicao = table.Column<int>(type: "int", nullable: false),
                    lancado = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantIdMicrosoft = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    auth_type = table.Column<int>(type: "int", nullable: false),
                    azure_ad_id = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
